    ...
    html: `
      <div class="wiawis-promo-item">
        ...
        <div class="wiawis-promo-content">
          ...
          <p class="wiawis-promo-text" style="color:#262626;">가장 빠른 선택은, 가장 좋은 조건일 때 완성됩니다.<br><br>에어로 로드의 기준, 와스(WAWS) 2 시리즈.<br>와스2 시리즈를 특별가로 만나십시오.<br><br>와스프로 XP 2 <span class="text-red">최대 25% 할인.</span></p>
